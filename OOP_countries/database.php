...
class Database  
{
	public function __construct()  //I put the $connection and $db_selected variables in the construct function to assure every time I instantiate a new database instance that the connection to the DB is made!
	{
